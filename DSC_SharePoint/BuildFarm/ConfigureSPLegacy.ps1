configuration ConfigureSPVM
{
    ...
    Node localhost
    {
		...
		SPInstallPrereqs SPPrereqs
        {
            ...
            InstallerPath = "\\vmware-host\Shared Folders\Media_Installer\SP19Binaries" + "\prerequisiteinstaller.exe"
            OnlineMode = $true
        ...
        SPInstall InstallSharePoint 
        {
				IsSingleInstance  = "Yes"
             Ensure = "Present" 
             BinaryDir = "\\vmware-host\Shared Folders\Media_Installer\SP19Binaries" 
        ...
        {
            BinaryDir = "\\vmware-host\Shared Folders\Media_Installer\SP19LanguagePack"
            Ensure = "Present"
